...
from scripts.connect_api import APIConnector
from scripts.files_utils import create_csv, create_parquet, parquet_to_csv, write_to_database, previous_date_str
...
write_to_database(filename_prefix="costs")
